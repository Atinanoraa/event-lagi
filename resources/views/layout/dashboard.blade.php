...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        ...
        <!-- Image Logo -->
        <!-- <a class="navbar-brand logo-image" href="index.html"><img src={{ asset('/dashboard/images/logo.svg') }} alt="alternative"></a> -->
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item" >
                    <a class="nav-link page-scroll" href="#header" style="color:#000000;">Home <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#events" style="color:#000000;">Events</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#pricing" style="color:#000000;">Pricing</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#request" style="color:#000000;">Request</a>
                </li>

                <!-- Dropdown Menu -->
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle page-scroll" href="#about" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false" style="color:#000000;">About</a>
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="/login" style="color:#000000;">Profile</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" style="font: bold; color:#000000;" href="/login">Login</a>
                </li>
            </ul>
        </div>
    </nav> <!-- end of navbar -->
